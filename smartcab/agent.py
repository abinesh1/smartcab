...
class LearningAgent(Agent):
	...
	def reset(self, destination=None, testing=False):
		...
		if testing:
			...
			self.epsilon=math.exp(-self.alpha*self.count)
			self.count+=1
	...
	def learn(self, state, action, reward):
		...
		if self.learning:
			...
			self.Q[state][action]=(1-self.alpha)*current+(reward*self.alpha)
...
def run():
	...
	agent = env.create_agent(LearningAgent,learning=True, epsilon=1.0, alpha=0.008)
